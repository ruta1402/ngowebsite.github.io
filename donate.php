        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-lg-5 col-sm-6">
              ...
              <div class="images">
                <a href="donatemoney.php"><image class="img img-comment-detail" src="kindness.png" height="300px" width="300px"></image></a>
              </div>
                <h3>Donate money</h3>
            ...
            <div class="col-lg-5 col-sm-6">
              <div class="pic1  card-effect">
              <div class="images">
                <a href="donatethings.php"><image class="img img-comment-detail" src="box.png" height="300px" width="300px"></image></a>
              </div>
                <h3>Donate things</h3>
              </div>
            </div>
